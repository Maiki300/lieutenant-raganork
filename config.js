...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '260978532917-260978532917@g.us',
    ...
    RG: process.env.RG || '260978532917-260978532917@g.us',
    ...
    BOT_NAME: process.env.BOT_NAME || 'lieutenant-Raganork',
