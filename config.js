...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.ibb.co/C1dRty8/b8d5c2a8aaf0f812eb60b1bab0448f1d.jpg Hey {sender}, I'm alive to serve 𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒\n Uptime: {uptime}",
    BLOCK_CHAT: process.env.BLOCK_CHAT || '',
    ALWAYS_ONLINE: convertToBool(process.env.ALWAYS_ONLINE) || true,
    AUTOMUTE_MSG: process.env.AUTOMUTE_MSG || '_Group automuted!_\n_(Change this by setting var AUTOMUTE_MSG)_',
    ANTI_SPAM: process.env.ANTI_SPAM || '260767611710',
    ...
    PMB: process.env.PMB || '_Personal messages allowed_',
    READ_COMMAND: convertToBool(process.env.READ_COMMAND) || true,
    SESSION: process.env.SESSION.trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f","deb80cd12ababea1c9b9a8ad6ce3fab2","78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '260767611710',
    BOT_INFO: process.env.BOT_INFO || '𝗟𝗶𝗲𝘂𝘁𝗲𝗻𝗮𝗻𝘁;Skl11;0;https://i.ibb.co/42XHfb7/eren-yeager-hd-attack-on-titan-2.jpg;https://chat.whatsapp.com/GcHrzmyI1YbDGKI5SoIyBI',
    RBG_KEY: process.env.RBG_KEY || '/',
    ALLOWED: process.env.ALLOWED || 'all',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"lieutenant",
    BOT_NAME: process.env.BOT_NAME || '𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒'
    ...
    ANTILINK_WARN: process.env.ANTILINK_WARN || '☢️',
    HEROKU: {
